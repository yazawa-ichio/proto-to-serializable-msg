...
public partial class AllParameter : IMessage
{
	...
	public long ValueSint64;

	public uint ValueFixed32;

	public ulong ValueFixed64;

	public int ValueSfixed32;

	public long ValueSfixed64;
	...
	public Dictionary<int, string> ValueMapString;

	public Dictionary<string, int> ValueMapInt;

	public EmptyMessage ValueMessage;

	public Dictionary<int, DependTest> ValueMapValueMessage;

	public TestEnum ValueTestEnum;
